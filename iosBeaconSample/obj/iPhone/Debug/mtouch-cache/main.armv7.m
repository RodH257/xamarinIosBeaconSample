...
extern void *mono_aot_module_iosBeaconSample_info;
...
{
	mono_aot_register_module (mono_aot_module_iosBeaconSample_info);
...
void monotouch_setup ()
{
	...
	monotouch_assembly_name = "iosBeaconSample.exe";
	mono_use_llvm = FALSE;
